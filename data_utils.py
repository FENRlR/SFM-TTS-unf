...
class TextAudioLoader(torch.utils.data.Dataset):
    ...
    def __init__(self, audiopaths_and_text, hparams):
        ...
        self.use_mel_spec_posterior = getattr(hparams, "use_mel", False)
    ...
    def _filter(self):
        ...
        for audiopath, sid, text in self.audiopaths_sid_text:
            ...
            if self.min_text_len <= len(text) and len(text) <= self.max_text_len:
                ...
                lengths.append(os.path.getsize(audiopath) // (2 * self.hop_length)) # ! removed if statement

                """
                #- Suggested from https://github.com/p0p4k/vits2_pytorch/issues/92
                ...
                if spec_length < self.min_audio_len // self.hop_length:
                    print(f"Audio is too short: {audiopath}")
                """
